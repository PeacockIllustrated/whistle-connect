                        ...
                        <div className="card p-4 bg-[var(--neutral-50)]">
                            <MessageBubble
                                message={{
                                    ...
                                    sender: { id: 'other', full_name: 'John Smith', role: 'coach', phone: null, postcode: null, avatar_url: null, club_name: null, latitude: null, longitude: null, created_at: '', updated_at: '' }
                                }}
                                isOwn={false}
                                showSender
                            />
                    ...
                    <section>
                        ...
                        <div className="card p-4">
                            ...
                            <div className="flex items-center gap-4 text-sm text-[var(--foreground-muted)]">
                                <span className="inline-flex items-center gap-1.5"><Calendar className="w-4 h-4" />Sat, Jan 4</span>
                                <span className="inline-flex items-center gap-1.5"><Clock className="w-4 h-4" />10:00am</span>
                            </div>
