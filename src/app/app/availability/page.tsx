...
export default function AvailabilityPage() {
    ...
    async function loadInitialData() {
        ...
        if (profileResult.data) {
            ...
            // Tournament opt-in: nullish fallback so old rows that pre-date
            // the 0159 column read as opted-out (matches the DB default).
        ...
        <div className="px-4 py-6 max-w-[var(--content-max-width)] mx-auto">
            ...
            <div className="card overflow-hidden mb-8">
                ...
                <div className="p-6 space-y-6">
                    ...
                    {/* Tournament opt-in — separate from central because the
                        commitment is bigger (full tournament day, often
                        multiple age groups). searchRefereesForBooking gates
                        on this when booking_type='tournament'. */}
                    <div className="flex items-start gap-3 bg-[var(--neutral-50)] p-4 rounded-xl border border-[var(--border-color)]">
                        <div className="pt-1">
                            <input
                                type="checkbox"
                        ...
                        <label htmlFor="tournament_opt_in" className="text-sm cursor-pointer select-none">
                            ...
                            <span className="text-xs text-[var(--foreground-muted)]">I am available to referee full tournament days</span>
                        </label>
                    </div>
                </div>
            </div>
